...
//        Page<Board> boards = boardRepostiory.findAll(pageable);
        Page<Board> boards = boardRepostiory.findByTitleContainingOrContentContaining(searchText, searchText, pageable);
